...
validates   :sspossbal, :ssposuo, :ssposvbmo, :ssposvbmi, :ssposvbmoth, :ssposaddsepm, :ssposoth,   numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 30000000,  :allow_nil => true, :allow_blank => false,  message: " Entry is not valid. Please check your entry"  }
