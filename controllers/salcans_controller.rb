...
#change params to get working
    ...
    def salcan_params
      ...
      :salcanprep, :salcanproc, :slacanoth, :salcanpsrp, :salcanpsop, :salcantsrp, :salcantsop, :salcanbeps, :salcanbepsp, :salcanbets, :salcanbetsp, :salcanhrsps, :salcanhrsts, :salcancomment,  :election_year_id, :county, :current_step
      )
    end
end
