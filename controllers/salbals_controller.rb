...
#change params to get working
    ...
    def salbal_params
      ...
      :salbaldesign, :salbaltrans, :salbalorder, :salbalmail, :salbalother, :salbalpsrp, :salbalpsop, :salbaltsrp, :salbaltsop, :salbalbeps, :salbalbepsp, :salbalbets, :salbalbetsp, :salbalhrsps, :salbalhrsts,  :election_year_id, :county, :current_step
      )
    end
end
