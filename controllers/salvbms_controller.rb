...
#change params to get working
    ...
    def salvbm_params
      ...
      :salvbmoutr, :salvbmappro, :salvbmuoapp, :salvbmproces, :salvbmoth, :salvbmpsrp, :salvbmpsop, :salvbmtsrp, :salvbmtsop, :salvbmbeps, :salvbmbepsp, :salvbmbets, :salvbmbetsp, :salvbmhrsps, :salvbmhrsts, :salvbmcomment,  :election_year_id, :county, :current_step
      )
    end
end
